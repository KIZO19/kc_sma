        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-lte-treeview="true" role="menu" data-accordion="false">
            ...
            <?php if (($role ?? '') === 'super_admin'): ?>
              ...
              <li class="nav-item has-treeview <?= (strpos($currentPath, '/ressources-humaines') !== false || strpos($currentPath, '/finances-statistiques') !== false) ? 'menu-open' : '' ?>">
                <a href="#" class="nav-link <?= (strpos($currentPath, '/ressources-humaines') !== false || strpos($currentPath, '/finances-statistiques') !== false) ? 'active' : '' ?>" data-lte-toggle="treeview">
                  <i class="nav-icon bi bi-grid-3x3-gap"></i>
                  <p>Modules <i class="bi bi-caret-down-fill float-end"></i></p>
                </a>
                <ul class="nav nav-treeview ps-3">
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/ressources-humaines" class="nav-link <?= (strpos($currentPath, '/ressources-humaines') !== false) ? 'active' : '' ?>">
                      <i class="nav-icon bi bi-people"></i>
                      <p>Ressources humaines</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/finances-statistiques" class="nav-link <?= (strpos($currentPath, '/finances-statistiques') !== false) ? 'active' : '' ?>">
              ...
              <li class="nav-item has-treeview <?= (strpos($currentPath, '/ecoles') !== false) ? 'menu-open' : '' ?>">
                <a href="#" class="nav-link <?= (strpos($currentPath, '/ecoles') !== false) ? 'active' : '' ?>" data-lte-toggle="treeview">
                  <i class="nav-icon bi bi-building"></i>
                  <p>Gestion des écoles <i class="bi bi-caret-down-fill float-end"></i></p>
                </a>
                <ul class="nav nav-treeview ps-3">
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/ecoles" class="nav-link <?= (strpos($currentPath, '/ecoles') !== false && strpos($currentPath, '/ecoles/create') === false && strpos($currentPath, '/ecoles/addSubscription') === false) ? 'active' : '' ?>">
                      <i class="nav-icon bi bi-list"></i>
                      <p>Liste des écoles</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/ecoles/create" class="nav-link <?= (strpos($currentPath, '/ecoles/create') !== false) ? 'active' : '' ?>">
                      <i class="nav-icon bi bi-plus-square"></i>
                      <p>Créer une école</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/ecoles/addSubscription" class="nav-link <?= (strpos($currentPath, '/ecoles/addSubscription') !== false) ? 'active' : '' ?>">
              ...
              <li class="nav-item has-treeview <?= (strpos($currentPath, '/abonnements') !== false || strpos($currentPath, '/ecoles/generatePassword') !== false) ? 'menu-open' : '' ?>">
                <a href="#" class="nav-link <?= (strpos($currentPath, '/abonnements') !== false || strpos($currentPath, '/ecoles/generatePassword') !== false) ? 'active' : '' ?>" data-lte-toggle="treeview">
                  <i class="nav-icon bi bi-person-badge"></i>
                  <p>Utilisateurs <i class="bi bi-caret-down-fill float-end"></i></p>
                </a>
                <ul class="nav nav-treeview ps-3">
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/abonnements" class="nav-link <?= (strpos($currentPath, '/abonnements') !== false) ? 'active' : '' ?>">
                      <i class="nav-icon bi bi-card-checklist"></i>
                      <p>Abonnement</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= BASE_URL ?>/ecoles/generatePassword" class="nav-link <?= (strpos($currentPath, '/ecoles/generatePassword') !== false) ? 'active' : '' ?>">
            ...
            <?php if (in_array($role ?? '', ['ecole_admin', 'préfet_école', 'DE_école', 'DD_école', 'DP_école', 'DA_école', 'comptable_école', 'sec_école', 'enseignant_école', 'eleve_ecole', 'parent_ecole'], true)): ?>
              <li class="nav-header">ACTIONS RAPIDES</li>
              <?php if (($role ?? '') === 'ecole_admin'): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/agents" class="nav-link <?= (strpos($currentPath, '/agents') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-people-fill"></i>
                    <p>Équipe & agents</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/paiements" class="nav-link <?= (strpos($currentPath, '/paiements') !== false) ? 'active' : '' ?>">
              ...
              <?php elseif (in_array($role ?? '', ['préfet_école', 'DE_école', 'DD_école', 'DP_école', 'DA_école'], true)): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/bulletins" class="nav-link <?= (strpos($currentPath, '/bulletins') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-file-earmark-text"></i>
                    <p>Bulletins</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/presences" class="nav-link <?= (strpos($currentPath, '/presences') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-calendar-check"></i>
                    <p>Présences</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/evaluations" class="nav-link <?= (strpos($currentPath, '/evaluations') !== false) ? 'active' : '' ?>">
              ...
              <?php elseif (($role ?? '') === 'comptable_école'): ?>
                ...
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/rapports" class="nav-link <?= (strpos($currentPath, '/rapports') !== false) ? 'active' : '' ?>">
              ...
              <?php elseif (($role ?? '') === 'sec_école'): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/inscriptions" class="nav-link <?= (strpos($currentPath, '/inscriptions') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-person-plus"></i>
                    <p>Nouvelle inscription</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/parents" class="nav-link <?= (strpos($currentPath, '/parents') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-people"></i>
                    <p>Gérer les parents</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/eleves" class="nav-link <?= (strpos($currentPath, '/eleves') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-person-badge"></i>
              ...
              <?php elseif (($role ?? '') === 'enseignant_école'): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/mes-cours" class="nav-link <?= (strpos($currentPath, '/mes-cours') !== false) ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/notes" class="nav-link <?= (strpos($currentPath, '/notes') !== false) ? 'active' : '' ?>">
              ...
              <?php elseif (($role ?? '') === 'eleve_ecole'): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/mon-emploi" class="nav-link <?= (strpos($currentPath, '/mon-emploi') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-calendar2-week"></i>
                    <p>Mon emploi du temps</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/mes-notes" class="nav-link <?= (strpos($currentPath, '/mes-notes') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-bar-chart-steps"></i>
                    <p>Mes notes</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/mes-presences" class="nav-link <?= (strpos($currentPath, '/mes-presences') !== false) ? 'active' : '' ?>">
              ...
              <?php elseif (($role ?? '') === 'parent_ecole'): ?>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/mes-enfants" class="nav-link <?= (strpos($currentPath, '/mes-enfants') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-people"></i>
                    <p>Suivi des enfants</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/bulletins-enfant" class="nav-link <?= (strpos($currentPath, '/bulletins-enfant') !== false) ? 'active' : '' ?>">
                    <i class="nav-icon bi bi-file-earmark-text"></i>
                    <p>Voir les bulletins</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= BASE_URL ?>/messages" class="nav-link <?= (strpos($currentPath, '/messages') !== false) ? 'active' : '' ?>">
