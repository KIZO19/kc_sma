    ...
    private function renderPage(string $route, string $role): array
    {
        ...
        $pages = [
            ...
            'facturation' => [
                ...
                'pageContent' => 'Suivi des factures, de la création des frais et des devises.',
                'pageNotes' => 'Accessible aux comptables et à l’administration. Le comptable gère les frais, devises et dérogations.',
            ],
            'comptes' => [
                'title' => 'Caisses & Banques',
                'pageTitle' => 'Caisses & Banques',
                'pageDescription' => 'Gérez les caisses et les comptes bancaires.',
                'pageContent' => 'Suivi des flux financiers de l’école, y compris la paie et les recouvrements.',
                'pageNotes' => 'Réservé aux comptables et aux responsables financiers. Le comptable planifie les recouvrements et gère la paie du personnel.',
            ],
            'rapports' => [
                'title' => 'Rapports',
                'pageTitle' => 'Rapports',
                ...
                'pageNotes' => 'Utilisé pour les bilans mensuels et trimestriels. Le comptable peut suivre paiements, paie, dérrogations et recouvrements.',
            ],
            'statistiques' => [
                'title' => 'Statistiques',
