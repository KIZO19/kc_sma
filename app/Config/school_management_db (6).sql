...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2026 at 10:28 AM
...
(3, 1, '3ème Technique Informatique', 3, NULL),
...
--
-- Dumping data for table `dettes_eleves`
--

INSERT INTO `dettes_eleves` (`id`, `eleve_id`, `frais_id`, `annee_scolaire_id`, `montant_initial`, `montant_restant`, `devise`, `date_creation`) VALUES
(1, 9, 2, 1, 45.00, 12.00, 'USD', '2026-08-09 16:48:30'),
(2, 9, 2, 1, 45.00, 10.00, 'USD', '2026-08-09 17:02:51'),
(3, 10, 14, 2, 112.00, 11.00, 'USD', '2026-08-26 23:04:06'),
(4, 10, 6, 2, 135.00, 111.00, 'USD', '2026-08-30 07:10:37');
...
(9, 6, 6, NULL, 'DEBIT', 135.00, NULL, '2026-08-26 20:46:28', 'Facturation inscription: Frais Scolaires -secondaire', 1),
(10, 6, 11, NULL, 'DEBIT', 15.00, NULL, '2026-08-26 20:46:28', 'Facturation inscription: Frais Tricot', 1),
(11, 6, 14, NULL, 'DEBIT', 112.00, NULL, '2026-08-26 23:04:06', 'Facturation: jsdc', 1),
(12, 6, 14, NULL, 'CREDIT', 1.00, 'REC-20260827010919-437', '2026-08-26 23:09:19', 'Frais de l\'Etat Secondaire - 112.00 CDF', 1),
(13, 6, 14, NULL, 'CREDIT', 100.00, 'REC-20260827012124-437', '2026-08-26 23:21:24', 'Frais de l\'Etat Secondaire - 112.00 CDF', 1),
(14, 6, 6, NULL, 'CREDIT', 24.00, 'REC-20260830091037-118', '2026-08-30 07:10:37', 'Frais Scolaires -secondaire - 135.00 USD', 1);
...
(10, 'NKUB00245', 'NKUBA', 'KASKOTI', 'JOHN', 'M', 'KANANGA', 'CONGOLAISE', 'Nakuwadde, Kampala', '2019-01-12', 6, 'KASKOOTI', 'ANGE', 'Équateur', '', '', '', '', '', NULL, 'actif', 4);
...
CREATE TABLE `frais_scolaires` (
  ...
  `ecole_id` int(11) DEFAULT NULL,
  `encodage` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `frais_scolaires` (`id`, `classe_id`, `type_frais`, `montant_total`, `annee_scolaire_id`, `devise`, `scope`, `scope_id`, `ecole_id`, `encodage`) VALUES
(1, 3, 'Minerval 1er Trimestre', 150.00, 1, 'USD', 'class', NULL, 4, NULL),
(2, NULL, 'Frais technique Nutrition', 45.00, 2, 'USD', 'option', 7, 4, NULL),
(3, 4, 'Frais de l\'Etat', 30000.00, 1, 'CDF', 'class', NULL, 4, NULL),
(4, NULL, 'FRAIS DE CONSTRUCTION', 1.00, 1, 'USD', 'school', NULL, 4, NULL),
(5, NULL, 'Frais de l\'Etat', 24000.00, 2, 'CDF', 'section', 2, 4, NULL),
(6, NULL, 'Frais Scolaires -secondaire', 135.00, 2, 'USD', 'section', 3, 4, NULL),
(7, NULL, 'Frais techniques Sociale', 30.00, 2, 'USD', 'option', 5, 4, NULL),
(8, NULL, 'Frais Scolaires Primaire', 70.00, 2, 'USD', 'section', 2, 4, NULL),
(9, NULL, 'Frais Scolaires Maternelle', 130.00, 2, 'USD', 'section', 1, 4, NULL),
(10, NULL, 'Frais de l\'Etat Primaire', 24000.00, 2, 'CDF', 'section', 2, 4, NULL),
(11, NULL, 'Frais Tricot', 15.00, 2, 'USD', 'school', NULL, 4, NULL),
(12, 8, 'Frais de Contrôle des Dossiers', 15.00, 2, 'USD', 'class', 8, 4, NULL),
(14, NULL, 'Frais de l\'Etat Secondaire', 30000.00, 2, 'CDF', 'section', 3, 4, NULL);
...
(6, 10, 7, 2, '2026-08-26 20:46:28', NULL, NULL, 'En cours');
...
(7, 'Nutrition Générale', NULL),
(8, 'Mécanique Générale', NULL),
(9, 'Construction', NULL),
(10, 'Eléctricité Générale', NULL);
...
(6, 10, 14, 1.00, '2026-08-26 23:09:19'),
(7, 10, 14, 100.00, '2026-08-26 23:21:24'),
(8, 10, 6, 24.00, '2026-08-30 07:10:37');
...
(6, 4, 'AGIZO KASKOTI', '0977342942', 'johkizo19@gmail.com', '$2y$10$6JPYhkWbOm43kWFMDtjZ3.V9CBbGOYDK6ey5GRBSKUY0ybQ1MGQ0i');
...
(143, 'Super Admin Test', 'super_admin@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'super_admin', NULL, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(144, 'École Admin Test', 'ecole_admin@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'ecole_admin', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(145, 'Préfet École Test', 'prefet_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'préfet_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(146, 'Directeur des études Test', 'DE_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'DE_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(147, 'Directeur Département Test', 'DD_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'DD_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(148, 'Directeur Principal Test', 'DP_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'DP_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(149, 'Directeur Adjoint Test', 'DA_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'DA_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(150, 'Comptable École Test', 'comptable_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'comptable_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(151, 'Secrétaire École Test', 'sec_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'sec_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(152, 'Promoteur École Test', 'promoteur_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'promoteur_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(153, 'Enseignant École Test', 'enseignant_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'enseignant_école', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(154, 'Élève École Test', 'eleve_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'eleve_ecole', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(155, 'Parent École Test', 'parent_ecole@test.local', '$2y$10$7ZBugOkKdrFPui8AMPjXHet4sNu8WZs1gH7ojNuf16..67ZbPMnfu', 'parent_ecole', 1, NULL, 'Actif', '2026-07-27 18:57:27', NULL, NULL),
(156, 'BAHATI', 'codekizo8@gmail.com', '$2y$10$EvotduSqp8rJDZZv6S9DuuhoaPcusUkzjlQ2cfVMUor7R9dkqxOFy', 'parent_ecole', 4, 5, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(157, 'ANGE AMINA', 'AMINA-20260703085920-252854', '$2y$10$rsTaXJtDmSUJoDyudA0laOvavI.UOYAdOgmnknQ6ytmrKXg69U8ge', 'eleve_ecole', 1, 4, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(158, 'PRUNELLE AGISHA', 'AGISHA-20260703122431-213539', '$2y$10$F/GN/a500kZXK8LkJiPLRu.8.ishja3hMeyjpXj6mjdYNc2akUaXm', 'eleve_ecole', 1, 5, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(159, 'angle Bahati', 'B-20260705013018-a99f18', '$2y$10$2W0x0DihtVQVSX7Msg6epOkhXQZuEOIS6mK5FDE0QrVQD1okucSce', 'eleve_ecole', 1, 6, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(160, 'Case Test', 'UNIQUE-TEST-1783237523', '$2y$10$yPJrv./C7r10c4yXVDC4OOSyCiOkW25lXBPSTZUh99uFMgKsSi.we', 'eleve_ecole', NULL, 7, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(161, 'Case Test', 'UNIQUE-TEST-1783237559', '$2y$10$uDMDwoLSkczobNSqFY.zSuV4vUfR4xb0IIwxz0kHtcpOSeHVFJ6lq', 'eleve_ecole', NULL, 8, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(162, 'MIRIAM ANGELA', 'ANGELA-20260705123651-584c73', '$2y$10$SpICOwv4w4OuBBQgDhL.pe8jwwDDjGtNLuoN/RB/hDggB7Bbr.p26', 'eleve_ecole', 4, 9, 'Actif', '2026-07-27 19:06:47', NULL, NULL),
(163, 'AGIZO KASKOTI', 'johkizo19@gmail.com', '$2y$10$LlRsbH4.PCy8lPPYDCRo8uKQC9CMlCC.ywrhQyE2jQPvrB01JTwHO', 'parent_ecole', 4, 6, 'Actif', '2026-08-26 20:46:28', NULL, NULL),
(164, 'JOHN NKUBA', 'NKUB00245', '$2y$10$sWjIiXyFQZ4dbLFY7415mO2R.K6J3X3wVsAlZIvfxFULEkq222pZi', 'eleve_ecole', 4, 10, 'Actif', '2026-08-26 20:46:28', NULL, NULL);
...
ALTER TABLE `frais_scolaires`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_frais_ecole_encodage` (`ecole_id`,`encodage`),
  ADD KEY `classe_id` (`classe_id`),
  ADD KEY `annee_scolaire_id` (`annee_scolaire_id`),
  ADD KEY `scope_id` (`scope_id`),
  ADD KEY `idx_frais_ecole` (`ecole_id`),
  ADD KEY `idx_frais_ecole_encodage` (`ecole_id`,`encodage`);
...
--
ALTER TABLE `frais_scolaires`
  ADD CONSTRAINT `fk_frais_ecole` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
